...
export const queryKeys = {
  ...
  adminUserDetail: (id: string) => [...queryKeys.adminUsers(), 'detail', id] as const,
  
  // Admin Apps
  adminApps: () => [...queryKeys.admin(), 'apps'] as const,
  adminAppsList: (filters?: { page?: number; limit?: number; userId?: string }) => 
    [...queryKeys.adminApps(), 'list', filters] as const,
  adminAppDetail: (id: string) => [...queryKeys.adminApps(), 'detail', id] as const,
  
  // Admin Chains
  adminChains: () => [...queryKeys.admin(), 'chains'] as const,
  adminChainsList: () => [...queryKeys.adminChains(), 'list'] as const,
  adminChainDetail: (id: string) => [...queryKeys.adminChains(), 'detail', id] as const,
  ...
  adminDefaultSettings: () => [...queryKeys.adminSettings(), 'default'] as const,
