...
import { adminUseCase } from "@/app/admin/usecases/admin.usecase";
import {
  UpdateUserRequest,
  UpdateAppRequest,
  UpdateChainRequest,
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: queryKeys.adminUserDetail(variables.userId),
      });
      toast({
        title: "User updated",
...
// App hooks
export const useAdminApps = (params?: {
  page?: number;
  limit?: number;
  userId?: string;
}) => {
...
export const useUpdateApp = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: queryKeys.adminAppDetail(variables.appId),
      });
      toast({
        title: "App updated",
