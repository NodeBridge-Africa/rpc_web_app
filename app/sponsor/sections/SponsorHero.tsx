...
import { community_link } from "@/constant";
    ...
    <section className="relative min-h-[80vh] w-full flex items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            Empower the African{" "}
            <span className="text-[#10B981]">Web3 Ecosystem</span>
          </motion.h1>
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Join our mission to build a robust blockchain infrastructure across
            Africa and support the next generation of Web3 developers.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="bg-[#10B981] hover:bg-[#059669] text-black gap-2 group"
            >
              <Link className="flex items-center" href={community_link}>
                Become a Sponsor
